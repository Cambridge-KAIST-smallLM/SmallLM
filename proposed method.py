...
config = LlamaConfig(vocab_size=vocab_size, hidden_size=4096, num_hidden_layers=24, num_attention_heads=16)
base_model = LlamaForCausalLM(config)  # Initialize LLaMA model from scratch
model = FrequencyBasedSelectiveUpdateLlama(base_model, vocab_size=vocab_size, num_tokens_to_update=500)
